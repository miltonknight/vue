...
import CaseStudiesArtical from "@/views/ma/case-studies/artical";

export default {
  name: "MaCaseStudiesArticalLayout",
  components: { CommonNav, CommonFooter, CommonTip, CaseStudiesArtical},
  data() {
    return {
      activeIndex: "1"
    };
