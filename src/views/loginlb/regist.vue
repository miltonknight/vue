<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;background:#107ebd;" @click.native.prevent="handleLogin">注册</el-button>

      <div class="tips">
        <span @click="LoginnK">已有账号去登录</span>
      </div>
