    ...
    <el-row :gutter="24">
      <div class="grid-content bg-purple follow-main">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <el-tab-pane label="找战友" name="third">
...
<script>
console.log("Views: /follow/index is loaded");

import Followed from "@/views/ma/follow/components/followed"
import Followers from "@/views/ma/follow/components/followers"
import FindFriends from "@/views/ma/follow/components/friends"
