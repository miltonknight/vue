<template>
  <div class="login-container">
    ...
    >
      ...
      <el-form-item>
        <el-button icon="el-icon-search" :disabled="disable" @click="getCode()">获取验证码</el-button>
      </el-form-item>
...
<script>
import { validUsername } from "@/utils/registerValidate";
  ...
  methods: {
    ...
    handleLogin() {
      ...
      this.$refs.loginForm.validate(valid => {
        ...
        postData("/dc/user/userapi/register", params)
          .then(response => {
            this.$message({
